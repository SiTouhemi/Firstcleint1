...
export function ArabicAdminLayout({ children, activeTab, onTabChange, onLogout }: ArabicAdminLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex" dir="rtl">
      ...
      <div
        className={cn(
          "fixed right-0 top-0 h-full bg-white border-l border-gray-200 z-40 transition-all duration-300 shadow-xl",
      ...
      {/* Main Content */}
      <main className={cn("flex-1 transition-all duration-300", isCollapsed ? "lg:mr-16" : "lg:mr-80")}>
